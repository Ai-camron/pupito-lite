...
const product: Product = {
  ...
  colors: [
    { name: 'Neon Pink', hex: '#FF69B4', inStock: true, swatchClass: 'bg-[#FF69B4]' },
    ...
    <div className="min-h-screen bg-linear-to-br from-[#0D0D0D] via-[#1A1A1A] to-[#0D0D0D]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center gap-2 text-gray-400 mb-8">
          ...
          <span>/</span>
          <Link href="/products" className="hover:text-[#FF69B4] transition-colors">Products</Link>
          <span>/</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-4">
            {/* Main Image */}
            <div className="relative aspect-square bg-linear-to-br from-[#FF69B4]/20 to-[#1E90FF]/20 rounded-2xl overflow-hidden">
              <Image
              ...
              <div className="absolute top-4 left-4 flex flex-col gap-2">
                ...
                {product.isSale && (
                  <span className="px-3 py-1 bg-[#FF69B4] text-white text-sm font-bold rounded-lg">
                    SALE
                  </span>
                )}
              </div>
              ...
              <div className="absolute top-4 right-4 flex gap-2">
                <button
                  ...
                  className={`p-2 rounded-full transition-colors ${
                    isWishlisted ? 'bg-[#FF69B4] text-white' : 'bg-black/50 text-white hover:bg-black/70'
                  }`}
              ...
              {product.images.map((image, index) => (
                <button
                  ...
                  className={`relative aspect-square w-20 h-20 rounded-lg overflow-hidden border-2 transition-all ${
                    selectedImage === index 
                      ? 'border-[#FF69B4] shadow-[0_0_15px_rgba(255,105,180,0.5)]' 
          ...
          <div className="space-y-6">
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                {product.originalPrice && (
                  <>
                    ...
                    <span className="px-2 py-1 bg-[#FF69B4]/20 text-[#FF69B4] text-sm font-bold rounded">
            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                ...
                <Link 
                  ...
                  className="text-[#FF69B4] hover:text-[#FF1493] transition-colors flex items-center gap-1"
                >
                  ...
                  <button
                    ...
                    className={`py-3 px-4 border-2 rounded-lg font-medium transition-all ${
                      selectedSize === size.size
                        ...
                        : size.inStock
                        ? 'border-gray-600 text-white hover:border-[#FF69B4] hover:text-[#FF69B4]'
            ...
            <button
              ...
              className="w-full py-4 bg-linear-to-r from-[#FF69B4] to-[#FF1493] hover:from-[#1E90FF] hover:to-[#00FFFF] text-black hover:text-white font-bold rounded-xl transition-all duration-300 flex items-center justify-center gap-3 shadow-[0_0_30px_rgba(255,105,180,0.3)] hover:shadow-[0_0_40px_rgba(30,144,255,0.4)]"
            >
              ...
              <ul className="space-y-2">
                {product.features.map((feature, index) => (
                  <li key={index} className="text-gray-300 flex items-start gap-2">
                    <span className="text-[#FF69B4] mt-1">•</span>
                    {feature}
                  </li>
                ))}
              </ul>
